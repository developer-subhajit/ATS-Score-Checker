...
from src.models.sbert_similarity import SBERTSimilarity
from src.models.tfidf_similarity import TFIDFSimilarity
from src.models.word2vec_similarity import Word2VecSimilarity
from src.preprocessing.file_handlers import DocumentReader
...
class ScoringSystem:
    ...
    def _calculate_similarity_cached(self, resume: str, job_description: str) -> Dict[str, Any]:
        ...
        # Add combined score
        scores["combined"] = {"score": weighted_sum, "weights_used": self.weights}
...
def calculate_resume_match(jd_path: str, cv_path: str) -> Dict[str, float]:
    ...
    try:
        ...
        return {
            ...
            "word2vec_score": scores["word2vec"]["normalized_score"],
